...
namespace BookInformationService.Controllers.v1
{
    [ApiController]
    ...
    public class BookInformationController : Controller
    {
        ...
        [SwaggerResponse(200, "Successfully retrieved book informations using version 1.0.0", typeof(List<BookInformation>))]
        [SwaggerResponse(404, "Book Informations not found")]
        [SwaggerResponse(500, "Internal Server Error")]
        public async Task<IActionResult> GetBookInformationsV100()
        {
            try
            {
        ...
        #region API Version 1.1.0

        [HttpGet]
        [MapToApiVersion("1.1")]
        [SwaggerOperation(Summary = "Get all book informations")]
        [SwaggerResponse(200, "Successfully retrieved book informations using version 1.1.0", typeof(List<BookInformation>))]
        [SwaggerResponse(404, "Book Informations not found")]
        [SwaggerResponse(500, "Internal Server Error")]
        public async Task<IActionResult> GetBookInformationsV110()
        {
            try
            {
                List<BookInformationDisplayDto>? bookInformationsDisplayDto = await _bookInfoBL.GetBookInformations();
